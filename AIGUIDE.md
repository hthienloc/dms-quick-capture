...
| `G` | (hold) Magnifier loupe |
| `1..4, Q..R, A..F, Z, B` | Tool shortcuts (from `CaptureConfig.toolShortcuts`) |
...
**onWheel**: G held → magnifier zoom (1.5–4.0); text tool → textFontSize; callout tool → calloutZoom; else → strokeWidth + preview
