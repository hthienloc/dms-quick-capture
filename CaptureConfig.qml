...
QtObject {
    ...
    readonly property var toolButtons: [
        { id: "pen", icon: "edit", shortcut: "1", tooltip: I18n.trFor("quickCapture", "Freehand Pen (1)") },
        { id: "line", icon: "horizontal_rule", shortcut: "2", tooltip: I18n.trFor("quickCapture", "Straight Line (2)") },
        { id: "arrow", icon: "trending_flat", shortcut: "3", tooltip: I18n.trFor("quickCapture", "Arrow (3)") },
        { id: "rect", icon: "crop_square", shortcut: "4", tooltip: I18n.trFor("quickCapture", "Rectangle Outline (4)") },
        { id: "ellipse", icon: "radio_button_unchecked", shortcut: "Q", tooltip: I18n.trFor("quickCapture", "Ellipse / Circle (Q)") },
        { id: "text", icon: "text_fields", shortcut: "W", tooltip: I18n.trFor("quickCapture", "Text (W)") },
        { id: "pixelate", icon: "blur_on", shortcut: "E", tooltip: I18n.trFor("quickCapture", "Pixelate (E)") },
        { id: "redact", icon: "ad_off", shortcut: "R", tooltip: I18n.trFor("quickCapture", "Redact (R)") },
        { id: "stamp", icon: "looks_one", shortcut: "A", tooltip: I18n.trFor("quickCapture", "Stamp (A)") },
        { id: "highlighter", icon: "border_color", shortcut: "S", tooltip: I18n.trFor("quickCapture", "Highlighter (S)") },
        { id: "spotlight", icon: "highlight", shortcut: "D", tooltip: I18n.trFor("quickCapture", "Spotlight (D)") },
        { id: "callout", icon: "zoom_in", shortcut: "Z", tooltip: I18n.trFor("quickCapture", "Callout (Z) | Hold G for Loupe") },
        { id: "background", icon: "wallpaper", shortcut: "B", tooltip: I18n.trFor("quickCapture", "Background (B)") }
    ]
    ...
    function getToolLabel(toolId) {
        ...
        if (toolId === "eraser") return I18n.trFor("quickCapture", "Eraser");
        if (toolId === "crop") return I18n.trFor("quickCapture", "Crop / Resize");
        if (toolId === "select") return I18n.trFor("quickCapture", "Select");
