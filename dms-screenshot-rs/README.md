...
Scroll capture keeps the desktop live under a translucent dim layer instead of freezing a background image. Every frame uses global capture and crops or composites the requested region, which prioritizes consistent alignment near output boundaries over the lower cost of direct output-region capture.
